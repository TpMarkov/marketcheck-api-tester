          ...
          <>
            ...
            >
              ...
              <div className="flex justify-between items-center px-10 py-8 border-b border-gray-100 shrink-0">
                <h2 className="text-2xl font-bold tracking-tighter uppercase">Filters</h2>
              ...
              <div className="flex-1 overflow-y-auto px-10 py-6">
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <select name="car_type" value={filters.car_type} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors appearance-none bg-transparent">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors appearance-none bg-transparent"
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      value={filters.model}
                      onChange={handleFilterChange}
                      className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors appearance-none bg-transparent disabled:opacity-30"
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input type="number" name="year_min" placeholder="2015" value={filters.year_min} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Max Year</label>
                      <input type="number" name="year_max" placeholder="2024" value={filters.year_max} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input type="number" name="price_max" placeholder="50000" value={filters.price_max} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Max Miles</label>
                      <input type="number" name="miles_max" placeholder="60000" value={filters.miles_max} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <select name="body_type" value={filters.body_type} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors appearance-none bg-transparent">
                    ...
                    <div className="space-y-2">
                      ...
                      <select name="fuel_type" value={filters.fuel_type} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors appearance-none bg-transparent">
                        <option value="">Any</option>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <select name="transmission" value={filters.transmission} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors appearance-none bg-transparent">
                        <option value="">Any</option>
                    ...
                    <div className="space-y-2">
                      ...
                      <select name="drivetrain" value={filters.drivetrain} onChange={handleFilterChange} className="w-full border-b border-gray-200 py-2.5 text-sm focus:border-black outline-none transition-colors appearance-none bg-transparent">
                        <option value="">Any</option>
              ...
              <div className="px-10 py-6 border-t border-gray-100 shrink-0">
                <button
                  ...
                  className="w-full bg-black text-white font-bold py-4 px-4 rounded-sm transition-all hover:bg-gray-900 uppercase text-[11px] tracking-[0.3em]"
                >
                  Apply Filters
                </button>
              </div>
